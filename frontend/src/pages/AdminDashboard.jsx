...
export default function AdminDashboard() {
  ...
  const [newHotel, setNewHotel] = useState({ name: '', location: '', imageUrl: '', totalRooms: 0, roomType: '', price: 0 });
  ...
  return (
    <div className="admin-dashboard" style={{ padding: 20 }}>
      ...
      <h3 className="admin-dashboard__heading">All Hotels</h3>
      ...
      <h3 className="admin-dashboard__heading">Bookings</h3>
      <div className="admin-dashboard__booking-list">
        {bookings.map((b) => (
          <div key={b.id} className="admin-dashboard__booking-card">
            ...
            {b.user && (
              <button className="btn-details" onClick={() => setSelectedUser(b.user)}>Details</button>
            )}<br />
